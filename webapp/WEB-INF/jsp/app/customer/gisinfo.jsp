        ...
        <div id="header">
            <div class="header_box">
                <div class="header_top">
                    ...
                    <span class="header_title">위치기반 서비스 이용약관</span>
...
제 1 조 (목적)
본 약관은 회원( 광역알뜰교통카드 서비스 약관에 동의한 자를 말합니다. 이하 "회원"이라고 합니다.) 이 국토교통부 (이하 "회사"라고 합니다.)가 제공하는 광역알뜰교통카드 서비스(이하 "서비스"라고 합니다)를 이용함에 있어 회사와 회원의 권리·의무 및 책임사항을 규정함을 목적으로 합니다.
...
서비스 내용
광역알뜰교통카드
광역알뜰교통카드 서비스는 재정부담 최소화, 교통비 절감, 사회편익 증가를 위해 사용자가 출퇴근 시간에 걷기 또는 자전거타기를 통해 이동한 거리를 측정하여 마일리지를 지급하고 사용자가 지급된 마일리지를 광역알뜰교통카드 충전 시 사용할 수 있는 서비스
...
제 6 조 (서비스내용변경 통지 등)
① 회사가 서비스 내용을 변경하거나 종료하는 경우 회사는 회원의 등록된 휴대폰번호로 문자전송을 통하여 서비스 내용의 변경 사항 또는 종료를 통지할 수 있습니다.
...
제1조 (시행일) 이 약관은 2019년 10월 1일 부터 시행한다.

제2조 위치정보관리책임자는 2019년 10월 1일 을 기준으로 다음과 같이 지정합니다.

1. 소     속 : 교통정책조정과
2. 연 락 처 : 044-201-3792
                    </pre>
                </div>
            </div>
        </div>