                                ...
                                <table class="uk-table uk-table-divider board-list">
                                    ...
                                    <tbody class="list">
                                     	<c:choose> 
		                                    ...
		                                    <tr>
	                                        	<td><input class="uk-checkbox" type="checkbox" id="ckId" value="${data.boardId},C"></td>
												<td class="num">${num } </td>
	                                            <td class="subject uk-text-left"><a href="#" onclick="$rcInfo.event.detailView('${data.boardId}','1001','C'); return false;"><c:out value="${data.title}"/></a></td>            
	                                            <td class="file">
