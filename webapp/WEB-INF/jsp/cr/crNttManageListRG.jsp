		...
		<div class="content-padder">
            <div class="uk-section-small">
                <div class="uk-container uk-container-large">
                    <h3>게시물 관리</h3>
                    <a href="#" class="uk-button uk-button-default board-select" id="selectBoxName"> 자동차 안전지식 <span uk-icon="chevron-down"></span></a>
                            ...
                            <div class="uk-card uk-card-default uk-card-body">
                                <form id="searchFrm" name="searchFrm" method="POST" onsubmit="return false;" action="" class="search-condition">
				                  ...
				                  <div class="uk-form-controls">
				                    ...
				                    <div class="" data-ax5picker="crNttRgDate" style="width: 292px; display: inline-table; vertical-align: middle; margin-bottom:2px;">
...
<!--                                             <th class="file">첨부</th> -->
                                    ...
                                    <tbody class="list">
                                     	<c:choose> 
		                                    ...
		                                    <tr>
	                                        	<td><input class="uk-checkbox" type="checkbox" id="ckId" value="${data.contentsId}"></td>
	                                        	<td class="num"><c:out value="${num}"/></td>
	                                            <td class="subject uk-text-left"><a href="javascript:void(0);" onclick="$crNttRg.event.detailView('<c:out value="${data.contentsId}"/>', '<c:out value="${data.divisionCode }" />');"><c:out value="${data.title}"/></a></td>
                                ...
                                <div class="btn-write">
                                    <div class="uk-text-left">
                                        <button type="button" class="uk-button uk-button-default" id="isOpenY" onclick="$crNttRg.event.isOpenClick('Y')">공개</button>
                                        <button type="button" class="uk-button uk-button-default" id="isOpenN" onclick="$crNttRg.event.isOpenClick('N')">비공개</button>
                                    </div>
                                ...
                                <ul class="uk-pagination uk-flex-center pagination" uk-margin>
                                	<c:if test="${not empty paginationInfo}"> 
                                		<ui:pagination paginationInfo="${paginationInfo}" type="custom" jsFunction="$crNttRg.event.fn_search"/>
                                    </c:if> 
                                </ul>
                            </div>
                        </div>
