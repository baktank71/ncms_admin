                        ...
                        <div>
                            ...
                            <div class="board-view">  
                                    ...
                                    <dd>
                                    	<c:choose>
                                    		<c:when test="${not empty pre }">
                                    			<a href="javascript:void(0)" onclick="$crNtt.event.detailView('${pre.contentsId }');">
                                    				${pre.title }
                                    			</a>		
                                    		</c:when>
                                    		<c:otherwise>
                                    ...
                                    <dd>
                                    	<c:choose>
                                    		<c:when test="${not empty next }">
                                    			<a href="javascript:void(0)" onclick="$crNtt.event.detailView('${next.contentsId }');" >
                                    				${next.title }
                                    			</a>
                                    		</c:when>
                                    		<c:otherwise>
                                ...
                                <div class="uk-text-center">
                                    <button type="button" class="uk-button uk-button-primary uk-margin-small-right" id="modifyBtn" onclick="$crNtt.event.goModify(<c:out value="${result.contentsId }" />)">수정</button>
                                    <button type="button" class="uk-button uk-button-primary uk-margin-small-right" id="deleteBtn" onclick="$crNtt.event.goDelete(<c:out value="${result.contentsId }" />)">삭제</button>
