		...
		<div class="content-padder">
            <div class="uk-section-small">
                <div class="uk-container uk-container-large">
                    <h3>게시물 관리</h3>
                    <a href="#" class="uk-button uk-button-default board-select" id="selectBoxName"> 리콜시행 및 무상수리 <span uk-icon="chevron-down"></span></a>
                    <div uk-dropdown="pos: bottom-right; mode: click; offset: 0;">
                       <ul class="uk-nav uk-navbar-dropdown-nav nav-list">
                           ...
                           <!-- <li value="0206"><a href="#" onClick="return false;">리콜시정현황</a></li> -->
                           <!-- <li value="0312"><a href="#" onClick="return false;">정보마당</a></li> -->
                           <li value="0701"><a href="#" onClick="return false;">관리자공지사항</a></li> 
                           <li value="0702"><a href="#" onClick="return false;">공지 팝업</a></li> 
                       </ul>
                    </div>
                        ...
                        <div>
                            <div class="uk-card uk-card-default uk-card-body">
                                <form id="searchFrm" name="searchFrm" method="POST" onsubmit="return false;" action="" class="search-condition">
                                    ...
                                    <legend>검색조건</legend>
                                    <c:choose>
                                    	<c:when test = "${params.divisionCode eq '0331' || params.divisionCode eq '0333' || params.divisionCode eq '0337' || params.divisionCode eq '0339'}">
                                    ...
                                    <tbody class="list">
                                     	<c:choose> 
		                                    ...
		                                    <tr>
													...
													<td class="num">${num } </td>
		                                            <td class="subject uk-text-left"><a href="javascript:void(0);" onclick="$crNtt.event.detailView('<c:out value="${data.contentsId}"/>');"><c:out value="${data.title}"/></a></td>            
		                                            <td class="file">
                                ...
                                <div class="btn-write">
                                    <div class="uk-text-left">
                                        <button type="button" class="uk-button uk-button-default" id="isOpenY" onclick="$crNtt.event.isOpenClick('Y')">공개</button>
                                        <button type="button" class="uk-button uk-button-default" id="isOpenN" onclick="$crNtt.event.isOpenClick('N')">비공개</button>
                                    </div>
                                ...
                                <ul class="uk-pagination uk-flex-center pagination" uk-margin>
                                	<c:if test="${not empty paginationInfo}"> 
                                		<ui:pagination paginationInfo="${paginationInfo}" type="custom" jsFunction="$crNtt.event.fn_search"/>
                                    </c:if> 
                                </ul>
                            </div>
                        </div>
