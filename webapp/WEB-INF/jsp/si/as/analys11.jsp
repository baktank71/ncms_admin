...
<script type="text/javascript" src="${contextPath}/js/si/as/analys11.js"></script>
<article>
          ...
          <div class="uk-card uk-card-default uk-card-body uk-child-width-1-1 area_full">
                         ...
                         <form class="search-condition uk-margin-medium-top">
                            ...
                            <div class="uk-form-controls">
                                ...
                                <div data-ax5select="defect" data-ax5select-config="{}" class="form-input-select" style="width: 100px; display: inline-table; vertical-align: middle; margin-bottom:2px;"></div>
                            </div>
